...
# Defining folds
splits = KFold(n_splits = kfolds, shuffle = True, random_state = 2)
train_labels = {value: key for (key, value) in total_set.class_to_idx.items()}


save_path = '/mnt/DataDrive164/lirj/medical/medical_dataset/21_11/05/12_cross_model/2_grey/resnet_weaken_v3/resnet50_0.0002_min0.1_random2_seed20_fold3'
