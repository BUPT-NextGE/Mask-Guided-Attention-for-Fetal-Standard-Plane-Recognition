...
save_path = '/mnt/DataDrive164/lirj/medical/medical_dataset/21_11/05/12_cross_model/2_grey/dual_erase_seed20_0.00015_share'
...
def load_model():
    ...
    model = MyEnsemble(modelA, modelA, nb_classes=2)
...
for fold, (train_idx, valid_idx) in enumerate(splits.split(total_set)):
    ...
    for epoch in range(h_epochs):
        ...
        for inputs,inputs_mask, labels in train_loader:
