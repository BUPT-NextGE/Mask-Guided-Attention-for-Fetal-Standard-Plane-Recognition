...
from model.resnet_weaken_v4 import resnet50_v3
...
print(train_labels)
save_path = '/mnt/DataDrive164/lirj/medical/medical_dataset/21_11/05/12_cross_model/2_grey/resnet_erase_v4_seed02/resnet50_0.0002_fold5'
