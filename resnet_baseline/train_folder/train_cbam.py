...
image_path = os.path.join(data_root, "/mnt/DataDrive164/lirj/medical/medical_dataset/21_11/05/9_cross/fold_2", "origin")  # flower data set path
...
net.load_state_dict(torch.load(model_weight_path, map_location={'cuda:0': 'cuda:2'}), strict=False)
...
epochs = 100
best_acc = 0.0
save_path = '/mnt/DataDrive164/lirj/medical/medical_dataset/21_11/05/12_cross_model/2_grey/resnet_singlefold_cbam/fold2_0.00015'
