...
# load model weights
weights_path = "/mnt/DataDrive164/lirj/medical/weights_backup/erase/resNet50_0_16_95.843.pth"
batch_size = 1
...
data_transform = {
    ...
    "val": transforms.Compose([transforms.Resize((224,224)),
                               transforms.ToTensor(),
                               transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])}
image_path = '/mnt/DataDrive164/lirj/medical/medical_dataset/21_11/05/9_cross/fold_0/origin/val/'
...
for image, target in validate_loader:
    ...
    _,o = model(image)
    image_n=(image.data.cpu().numpy()).flatten()
    embs.append(image_n)
