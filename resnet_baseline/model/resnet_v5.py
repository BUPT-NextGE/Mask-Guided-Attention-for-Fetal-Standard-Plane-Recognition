...
class AttentionBalance(nn.Module):
    ...
    def __init__(self, max_threshold=0.7, min_threshold=0.1):
        ...
        self.max_threshold = max_threshold*0.1887
    ...
    def forward(self, z):
        ...
        print("是否超过阈值：",max > self.max_threshold)
        print("阈值的种类：",set(max > self.max_threshold))

        print("超过阈值得到的数组大小：",(max > self.max_threshold).size())
        print("阈值：", self.max_threshold)
        print("数组：",max)
